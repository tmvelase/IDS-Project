package com.teamdev.filewatch.demo;
...
public class FileWatcherDemo extends javax.swing.JFrame
{
  ...
  public FileWatcherDemo()
  {
    super("JxFileWatcher Demo");
    ...
    startButton = new JButton(new AbstractAction("  Start  ") {
      public void actionPerformed(ActionEvent e) {
        if (FileWatcherDemo.this.startWatching()) {
    ...
    stopButton = new JButton(new AbstractAction("  Stop  ") {
      public void actionPerformed(ActionEvent e) {
        if (FileWatcherDemo.this.stopWatching()) {
          FileWatcherDemo.this.processStopWatching();
        }
      }
    });
    ...
    closeButton = new JButton(new AbstractAction("  Close  ") {
      public void actionPerformed(ActionEvent e) {
        FileWatcherDemo.this.stopWatching();
        dispose();
        System.exit(0);
      }
    });
    ...
    filter.addItem("Java files (*.java)");
    filter.setToolTipText("You can choose one of the available values or specify your own file mask filter, for example: *.doc");
  ...
  private void createUI() {
    ...
    JLabel caption = new JLabel("Welcome to JxFileWatcher demo!");
    ...
    JLabel text = new JLabel("This application demonstrates the functionality of JxFileWatcher cross-desktop library.");
  ...
  private boolean startWatching() {
    ...
    case 2: 
      ...
      break;
    case 3: 
      watcher.setFilter(new com.teamdev.filewatch.FileMaskFilter("*.java"));
    }
    ...
    watcher.addFileEventsListener(new com.teamdev.filewatch.FileEventsListener() {
      public void fileAdded(com.teamdev.filewatch.FileEvent.Added e) {
        FileWatcherDemo.this.writeToConsole(e.toString());
      }
  ...
  public static void main(String[] args) throws Exception {
    ...
    javax.swing.SwingUtilities.invokeLater(new Runnable() {
      public void run() {
        FileWatcherDemo watcherDemo = new FileWatcherDemo();
